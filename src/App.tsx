          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-lg text-[#2C1818]/80 leading-relaxed mb-6">
                "This brand is not just a food product, it's a story of how I love to sprinkle a little bit of joy into your life with beautiful food—with a cozy warm hug which you will never forget."
              </p>
